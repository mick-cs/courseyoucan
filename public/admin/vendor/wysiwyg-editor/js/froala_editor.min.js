...
function(a) {
    ...
    a.extend(a.FroalaEditor.DEFAULTS, {
        ...
        function c(a) {
            ...
            for (d = 0; d < e.length; d++) e[d].nodeType == Node.ELEMENT_NODE && e[d].textContent.replace(/\u200b/g, "").length != e[d].textContent.length && c(e[d])
        }
    ...
    a.FroalaEditor.NO_DELETE_TAGS = ["TH", "TD", "TABLE"], a.FroalaEditor.SIMPLE_ENTER_TAGS = ["TH", "TD", "LI"], a.FroalaEditor.MODULES.cursor = function(b) {
        ...
        function h(c) {
            ...
            if (d && "BLOCKQUOTE" == d.tagName) {
                var e = b.node.deepestParent(c, [a(c).parentsUntil(b.$el, "BLOCKQUOTE").get(0)]);
                e && e.previousSibling && (d = e)
            }
            if (null !== d) {
                var f, g = d.previousSibling;
                if (b.node.isBlock(d) && g && a.FroalaEditor.NO_DELETE_TAGS.indexOf(g.tagName) < 0)
                    if (b.node.isBlock(g))
                        if (b.node.isEmpty(g) && !b.node.isList(g)) a(g).remove();
                        else {
                            if (b.node.isList(g) && (g = a(g).find("li:last").get(0)), f = b.node.contents(g), f.length && "BR" == f[f.length - 1].tagName && a(f[f.length - 1]).remove(), "BLOCKQUOTE" == g.tagName && "BLOCKQUOTE" != d.tagName)
                                for (f = b.node.contents(g); f.length && b.node.isBlock(f[f.length - 1]);) g = f[f.length - 1], f = b.node.contents(g);
                            else if ("BLOCKQUOTE" != g.tagName && "BLOCKQUOTE" == d.tagName)
                                for (f = b.node.contents(d); f.length && b.node.isBlock(f[0]);) d = f[0], f = b.node.contents(d);
                            a(c).replaceWith(a.FroalaEditor.MARKERS), a(g).append(d.innerHTML), a(d).remove()
                        } else a(c).replaceWith(a.FroalaEditor.MARKERS), "BLOCKQUOTE" == d.tagName && g.nodeType == Node.ELEMENT_NODE ? a(g).remove() : (a(g).after(b.node.isEmpty(d) ? "" : a(d).html()), a(d).remove(), "BR" == g.tagName && a(g).remove())
            }
        }
        ...
        function k(c) {
            ...
            if (null !== d) {
                var f, g = d.nextSibling;
                if (b.node.isBlock(d) && g && a.FroalaEditor.NO_DELETE_TAGS.indexOf(g.tagName) < 0)
                    if (b.node.isBlock(g))
                        if (b.node.isList(g))
                            if (b.node.isEmpty(d, !0)) a(d).remove(), a(g).find("li:first").prepend(a.FroalaEditor.MARKERS);
                            else {
                                var h = a(g).find("li:first");
                                "BLOCKQUOTE" == d.tagName && (f = b.node.contents(d), f.length && b.node.isBlock(f[f.length - 1]) && (d = f[f.length - 1])), 0 === h.find("ul, ol").length && (a(c).replaceWith(a.FroalaEditor.MARKERS), h.find(b.html.blockTagsQuery()).not("ol, ul, table").each(function() {
                                    this.parentNode == h.get(0) && a(this).replaceWith(a(this).html() + (b.node.isEmpty(this) ? "" : "<br>"))
                                }), a(d).append(b.node.contents(h.get(0))), h.remove(), 0 === a(g).find("li").length && a(g).remove())
                            } else {
                    if (f = b.node.contents(g), f.length && "BR" == f[0].tagName && a(f[0]).remove(), "BLOCKQUOTE" != g.tagName && "BLOCKQUOTE" == d.tagName)
                        for (f = b.node.contents(d); f.length && b.node.isBlock(f[f.length - 1]);) d = f[f.length - 1], f = b.node.contents(d);
                    else if ("BLOCKQUOTE" == g.tagName && "BLOCKQUOTE" != d.tagName)
                        for (f = b.node.contents(g); f.length && b.node.isBlock(f[0]);) g = f[0], f = b.node.contents(g);
                    a(c).replaceWith(a.FroalaEditor.MARKERS), a(d).append(g.innerHTML), a(g).remove()
                } else {
                    for (a(c).replaceWith(a.FroalaEditor.MARKERS); g && "BR" !== g.tagName && !b.node.isBlock(g);) {
                        var i = g;
                        g = g.nextSibling, a(d).append(i)
                    }
                    g && "BR" == g.tagName && a(g).remove()
                }
            }
        }
        ...
        function p(c, d) {
            ...
            if (g && "BLOCKQUOTE" == g.tagName) {
                if (e(c, g)) {
                    var h = b.html.defaultTag();
                    return h ? a(g).before("<" + h + ">" + a.FroalaEditor.MARKERS + "<br></" + h + ">") : a(g).before(a.FroalaEditor.MARKERS + "<br>"), a(c).remove(), !1
                }
                f(c, g) ? o(c, d, !0) : q(c, d, !0)
            }
            null == g ? a(c).replaceWith("<br>" + a.FroalaEditor.MARKERS) : (b.node.isBlock(g) ? d ? (a(c).remove(), a(g).prepend("<br>" + a.FroalaEditor.MARKERS)) : a(g).before(b.node.openTagString(g) + "<br>" + b.node.closeTagString(g)) : a(g).before("<br>"), a(c).remove())
        }
        ...
        function r(e) {
            ...
            b.$el.get(0).normalize();
            var h = !1;
            a(f).parentsUntil(b.$el, "BLOCKQUOTE").length > 0 && (e = !1, h = !0), a(f).parentsUntil(b.$el, "TD, TH").length && (h = !1), c(f) ? !g(f) || e || h ? o(f, e, h) : b.cursorLists._endEnter(f) : d(f) ? !g(f) || e || h ? p(f, e) : b.cursorLists._startEnter(f) : !g(f) || e || h ? q(f, e, h) : b.cursorLists._middleEnter(f), n(), b.html.fillEmptyBlocks(!0), b.html.cleanEmptyTags(!0), b.clean.lists(), b.html.normalizeSpaces(), b.selection.restore()
        }
        return {
...
function(a) {
    ...
    a.FroalaEditor.MODULES.node = function(b) {
        ...
        function g(c, d, e) {
            if ("undefined" == typeof d && (d = []), "undefined" == typeof e && (e = !0), d.push(b.$el.get(0)), d.indexOf(c.parentNode) >= 0 || c.parentNode && a(c.parentNode).hasClass("fr-inner") || c.parentNode && a.FroalaEditor.SIMPLE_ENTER_TAGS.indexOf(c.parentNode.tagName) >= 0 && e) return null;
            for (; d.indexOf(c.parentNode) < 0 && c.parentNode && !a(c.parentNode).hasClass("fr-inner") && (a.FroalaEditor.SIMPLE_ENTER_TAGS.indexOf(c.parentNode.tagName) < 0 || !e);) c = c.parentNode;
            return c
        }
...
function(a) {
    ...
    a.FroalaEditor.MODULES.selection = function(b) {
        ...
        function l() {
            ...
            b.$el.is(":focus") && b.browser.msie || b.$el.focus(), f();
                ...
                if (l.length > 0) {
                    ...
                    try {
                        ...
                        if (j.nextSibling == l || l.nextSibling == j) {
                            for (var o = j.nextSibling == l ? j : l, p = o == j ? l : j, q = o.previousSibling; q && q.nodeType == Node.TEXT_NODE && 0 == q.length;) {
                                var r = q;
                                q = q.previousSibling, a(r).remove()
                            }
                            if (q && q.nodeType == Node.TEXT_NODE)
                                for (; q && q.previousSibling && q.previousSibling.nodeType == Node.TEXT_NODE;) q.previousSibling.textContent = q.previousSibling.textContent + q.textContent, q = q.previousSibling, a(q.nextSibling).remove();
                            for (var s = p.nextSibling; s && s.nodeType == Node.TEXT_NODE && 0 == s.length;) {
                                var r = s;
                                s = s.nextSibling, a(r).remove()
                            }
                            if (s && s.nodeType == Node.TEXT_NODE)
                                for (; s && s.nextSibling && s.nextSibling.nodeType == Node.TEXT_NODE;) s.nextSibling.textContent = s.textContent + s.nextSibling.textContent, s = s.nextSibling, a(s.previousSibling).remove();
                            if (q && b.node.isVoid(q) && (q = null), s && b.node.isVoid(s) && (s = null), q && s && q.nodeType == Node.TEXT_NODE && s.nodeType == Node.TEXT_NODE) {
                                a(j).remove(), a(l).remove();
                                var t = q.textContent.length;
                                q.textContent = q.textContent + s.textContent, a(s).remove(), b.html.normalizeSpaces(q), k.setStart(q, t), k.setEnd(q, t), n = !0
                            } else !q && s && s.nodeType == Node.TEXT_NODE ? (a(j).remove(), a(l).remove(), b.html.normalizeSpaces(s), k.setStart(s, 0), k.setEnd(s, 0), n = !0) : !s && q && q.nodeType == Node.TEXT_NODE && (a(j).remove(), a(l).remove(), b.html.normalizeSpaces(q), k.setStart(q, q.textContent.length), k.setEnd(q, q.textContent.length), n = !0)
                        }
                        if (!n) {
                            var u, v;
                            b.browser.chrome && j.nextSibling == l ? (u = m(l, k, !0) || k.setStartAfter(l), v = m(j, k, !1) || k.setEndBefore(j)) : (u = m(j, k, !0) || k.setStartBefore(j), v = m(l, k, !1) || k.setEndAfter(l)), "function" == typeof u && u(), "function" == typeof v && v()
                        }
                    } catch (w) {
                        console.log("RESTORE RANGE", w)
                    }
                }
                g.addRange(k)
            }
        ...
        function q() {
            if (o()) return !1;
            b.$el.find("td").prepend('<span class="fr-mk">' + a.FroalaEditor.INVISIBLE_SPACE + "</span>");
            var c = !1,
                d = p(b.$el.get(0));
        ...
        function r(c, d) {
            ...
            for (var f = 0; f < e.length; f++) {
                var g = e[f];
                a(g).hasClass("fr-marker") ? d = (d + 1) % 2 : d ? a(g).find(".fr-marker").length > 0 ? d = r(a(g), d) : ["TD", "TH"].indexOf(g.tagName) < 0 && !a(g).hasClass("fr-inner") ? a(g).remove() : a(g).hasClass("fr-inner") ? 0 == a(g).find(".fr-inner").length ? a(g).html("<br>") : a(g).find(".fr-inner").filter(function() {
                    return 0 == a(this).find("fr-inner").length
                }).html("<br>") : (a(g).empty(), a(g).attr("data-del-cell", !0)) : a(g).find(".fr-marker").length > 0 && (d = r(a(g), d))
            }
            return d
        }
        ...
        function t() {
            ...
            if (n()) {
                r(b.$el, 0), b.$el.find("table").filter(function() {
                ...
                for (var e = b.$el.find('.fr-marker[data-type="true"]'), f = 0; f < e.length; f++) {
                    var j = e[f],
                        m = j.nextSibling,
                        o = b.$el.find('.fr-marker[data-type="false"][data-id="' + a(j).data("id") + '"]').get(0);
                    if (o) {
                        if (m && m == o);
                        else if (j) {
                            var p = b.node.blockParent(j),
                                q = b.node.blockParent(o);
                            if (a(j).after(o), p == q);
                            else if (null == p) {
                                var s = b.node.deepestParent(j);
                                s ? (a(s).after(a(q).html()), a(q).remove()) : 0 == a(q).parentsUntil(b.$el, "table").length && (a(j).next().after(a(q).html()), a(q).remove())
                            } else if (null == q && 0 == a(p).parentsUntil(b.$el, "table").length) {
                                for (var m = p; !m.nextSibling && m.parentNode != b.$el.get(0);) m = m.parentNode;
                                for (m = m.nextSibling; m && "BR" != m.tagName;) {
                                    var t = m.nextSibling;
                                    a(p).append(m), m = t
                                }
                            } else 0 == a(p).parentsUntil(b.$el, "table").length && 0 == a(q).parentsUntil(b.$el, "table").length && (a(p).append(a(q).html()), a(q).remove())
                        }
                    } else o = a(j).clone().attr("data-type", !1), a(j).after(o)
                }
            }
            b.html.fillEmptyBlocks(!0), b.html.cleanEmptyTags(!0), b.clean.lists(), b.html.normalizeSpaces(), l()
        }
        ...
        function w(c) {
            ...
            return d ? (b.node.isBlock(d) ? v(d) : "BR" == d.tagName ? a(d).before(a.FroalaEditor.MARKERS) : a(d).after(a.FroalaEditor.MARKERS), !0) : !1
        }

        function x(c) {
            for (var d = c.nextSibling; d && d.nodeType == Node.TEXT_NODE && 0 == d.textContent.length;) d = d.nextSibling;
            return d ? (b.node.isBlock(d) ? u(d) : a(d).before(a.FroalaEditor.MARKERS), !0) : !1
        }
        return {
            require: ["markers"],
            text: c,
...
function(a) {
    ...
    a.FroalaEditor.MODULES.events = function(b) {
        ...
        function i(c) {
            ...
            if (!b.$el.is(":focus") && c) return b.$el.focus(), !1;
            if (!b.$el.is(":focus") || b.$el.find(".fr-marker").length > 0) return !1;
        ...
        function t(c, d, e) {
            if (!b.edit.isDisabled() || e) {
                var f = x[c];
                if (f)
                    for (var g = 0; g < f.length; g++) d = f[g].apply(b, [d]) || d;
...
function(a) {
    "use strict";
    a.FroalaEditor.UNICODE_NBSP = " ", a.FroalaEditor.VOID_ELEMENTS = ["area", "base", "br", "col", "embed", "hr", "img", "input", "keygen", "link", "menuitem", "meta", "param", "source", "track", "wbr"], a.FroalaEditor.BLOCK_TAGS = ["p", "div", "h1", "h2", "h3", "h4", "h5", "h6", "pre", "blockquote", "ul", "ol", "li", "table", "td", "th", "thead", "tfoot", "tbody", "tr", "hr"], a.extend(a.FroalaEditor.DEFAULTS, {
            ...
            if (e && (f = 'div class="fr-temp-div"'), f)
                for (var g = b.node.contents(d.get(0)), h = null, i = 0; i < g.length; i++) {
                    ...
                    if (j.nodeType == Node.ELEMENT_NODE && b.node.isBlock(j)) h = null;
                        ...
                        if (null == h) e ? a(j).replaceWith("<" + f + ' data-empty="true"><br/></div>') : a(j).replaceWith(a("<" + f + ">"));
                        else {
                            a(j).remove();
        ...
        function n(c) {
            if ("undefined" == typeof c && (c = b.$el.get(0)), c.nodeType == Node.ELEMENT_NODE)
                for (var d = b.node.contents(c), e = d.length - 1; e >= 0; e--) a(d[e]).hasClass("fr-marker") || n(d[e]);
            else if (c.nodeType == Node.TEXT_NODE && c.textContent.length > 0) {
                var f = c.previousSibling,
                    g = c.nextSibling;
                if (b.node.isBlock(f) && b.node.isBlock(g) && 0 === c.textContent.trim().length) a(c).remove();
                else {
                    var h = c.textContent;
        ...
        function t() {
            null != c() && b.core.isEmpty() && 0 === b.$el.find(f()).length && (b.$el.is(":focus") ? (b.$el.html("<" + c() + ">" + a.FroalaEditor.MARKERS + "<br/></" + c() + ">"), b.selection.restore()) : b.$el.html("<" + c() + "><br/></" + c() + ">"))
        }
...
function(a) {
    ...
    a.FroalaEditor.ENTER_P = 0, a.FroalaEditor.ENTER_DIV = 1, a.FroalaEditor.ENTER_BR = 2, a.FroalaEditor.KEYCODE = {
        ...
        function j(h) {
            ...
            var j = h.which;
            if (b.selection.isFull() && (n(j) && !m(h) || j == a.FroalaEditor.KEYCODE.BACKSPACE || j == a.FroalaEditor.KEYCODE.DELETE)) {
                b.CTRL_A = !1;
                var k = b.html.defaultTag();
                k ? b.$el.html("<" + k + ">" + a.FroalaEditor.MARKERS + "<br/></" + k + ">") : b.$el.html(a.FroalaEditor.MARKERS + "<br/>"), b.selection.restore()
            }
            j == a.FroalaEditor.KEYCODE.ENTER ? h.shiftKey ? d(h) : c(h) : j != a.FroalaEditor.KEYCODE.BACKSPACE || m(h) ? j != a.FroalaEditor.KEYCODE.DELETE || m(h) ? j == a.FroalaEditor.KEYCODE.SPACE ? g(h) : j == a.FroalaEditor.KEYCODE.TAB ? i(h) : m(h) || !n(h.which) || b.selection.isCollapsed() || b.selection.remove() : f(h) : e(h), b.events.enableBlur()
        }

        function k(c) {
            for (var d = 0; d < c.length; d++) c[d].nodeType == Node.TEXT_NODE && /\u200B/gi.test(c[d].textContent) ? (c[d].textContent = c[d].textContent.replace(/\u200B/gi, ""), 0 === c[d].textContent.length && a(c[d]).remove()) : c[d].nodeType == Node.ELEMENT_NODE && "IFRAME" != c[d].nodeType && k(b.node.contents(c[d]))
        }
        ...
        function l() {
            ...
            i(j) && 0 === a(j).find("li").length && !a(j).hasClass("fr-marker") && "IFRAME" != j.tagName && (b.selection.save(), k(b.node.contents(j)), b.selection.restore())
        }
        ...
        function o(a) {
            var c = a.which;
            return m(a) || c >= 37 && 40 >= c ? !0 : (s || (t = b.snapshot.get()), clearTimeout(s), void(s = setTimeout(function() {
                s = null, b.undo.saveStep()
            }, 500)))
        }

        function p(a) {
            return m(a) ? !0 : void(t && s && (b.undo.saveStep(t), t = null))
        }

        function q() {
            s && (clearTimeout(s), b.undo.saveStep(), t = null)
        }

        function r() {
            if (b.events.on("keydown", o), b.events.on("keyup", p), b.events.on("keydown", j), b.events.on("keyup", l), b.events.on("cut", h), b.browser.msie) try {
                b.$el.get(0).msGetInputContext && (b.$el.get(0).msGetInputContext().addEventListener("MSCandidateWindowShow", function() {
                    u = !0
...
function(a) {
    ...
    a.extend(a.FroalaEditor.DEFAULTS, {
        ...
        function c() {
            a.$el.height(a.opts.height), a.$el.css("minHeight", a.opts.heightMin), a.$wp.css("maxHeight", a.opts.heightMax), a.$wp.width(a.opts.width)
        }
...
function(a) {
    ...
    a.FroalaEditor.MODULES.snapshot = function(a) {
        ...
        function f() {
            var b = {};
            if (a.events.trigger("snapshot.before"), b.html = a.$el.html(), b.ranges = [], a.selection.inEditor() && a.$el.is(":focus"))
...
function(a) {
    ...
    a.FroalaEditor.MODULES.button = function(b) {
        ...
        function f(d) {
            ...
            0 == f.parents(".fr-popup").length && b.popups.hideAll(), f.hasClass("fr-dropdown") ? c(d) : (e(d), a.FroalaEditor.COMMANDS[f.data("cmd")] && 0 != a.FroalaEditor.COMMANDS[f.data("cmd")].refreshAfterCallback && o())
        }
        ...
        function l(a, c) {
            ...
            var f = '<a role="button" tabindex="-1" title="' + b.language.translate(c.title) + '" class="fr-command fr-btn' + ("dropdown" == c.type ? " fr-dropdown" : "") + (c.back ? " fr-back" : "") + '" data-cmd="' + a + '">' + e + "</a>";
            if ("dropdown" == c.type) {
                var g = '<div class="fr-dropdown-menu"><div class="fr-dropdown-wrapper"><div class="fr-dropdown-content" tabindex="-1">';
                g += k(a, c), g += "</div></div></div>", f += g
            }
            return f
        }
        ...
        function o() {
            return 0 == b.events.trigger("buttons.refresh") ? !1 : void setTimeout(function() {
                for (var c = b.selection.inEditor() && b.$el.is(":focus"), d = 0; d < q.length; d++) {
                    var e = a(q[d]),
                        f = e.data("cmd");
...
function(a) {
    ...
    a.FroalaEditor.POPUP_TEMPLATES = {
        ...
        function c(a, b) {
            s[a].data("container", b), b.append(s[a])
        }

        function d(d, f, g, h) {
            l([d]);
            var i = s[d].outerWidth(),
                j = (s[d].outerHeight(), e(d));
            s[d].addClass("fr-active");
            var k = s[d].data("container");
            b.opts.toolbarInline && k && b.$tb && k.get(0) == b.$tb.get(0) && (c(d, b.opts.toolbarInline ? a(b.opts.scrollableContainer) : b.$box), g && (g = b.$tb.offset().top - b.helpers.getPX(b.$tb.css("margin-top"))), f && (f = b.$tb.offset().left + b.$tb.width() / 2), b.$tb.hasClass("fr-above") && (g += b.$tb.outerHeight()), h = 0), k = s[d].data("container"), !b.opts.iframe || h || j || (f && (f -= b.$iframe.offset().left), g && (g -= b.$iframe.offset().top)), f && (f -= i / 2), b.opts.toolbarBottom && k && b.$tb && k.get(0) == b.$tb.get(0) && (s[d].addClass("fr-above"), g -= s[d].outerHeight()), b.position.at(f, g, s[d], h || 0);
            var m = s[d].find("input:visible, textarea:visible").get(0);
            m && (b.events.disableBlur(), a(m).select().focus()), b.opts.toolbarInline && !b.helpers.isMobile() && b.toolbar.hide()
        }

        function e(a) {
            return s[a] && s[a].hasClass("fr-active")
        }
        ...
        function g(a) {
            s[a] && s[a].hasClass("fr-active") && (b.events.trigger("popups.hide." + a), s[a].removeClass("fr-active fr-above"), b.events.disableBlur(), s[a].find("input, textarea, button, checkbox").filter(":focus").blur())
        }
        ...
        function k(c) {
            ...
            for (var d = s[c].find(".fr-command"), e = 0; e < d.length; e++) {
                var f = a(d[e]);
        ...
        function l(a) {
            ...
            for (var b in s) a.indexOf(b) < 0 && g(b)
        }
        ...
        function p(c, d) {
            var f = o(c, d),
                h = a('<div class="fr-popup' + (b.helpers.isMobile() ? " fr-mobile" : " fr-desktop") + (b.opts.toolbarInline ? " fr-inline" : "") + '">' + f + "</div>");
            b.opts.theme && h.addClass(b.opts.theme + "-theme"), "auto" != b.opts.direction && h.removeClass("fr-ltr fr-rtl").addClass("fr-" + b.opts.direction), h.find("input, textarea").attr("dir", b.opts.direction);
            var i = a("body");
            return i.append(h), h.data("container", i), s[c] = h, b.button.bindCommands(h, !1), a(b.original_window).on("resize.popups" + b.id, function() {
                b.helpers.isMobile() || (b.events.disableBlur(), g(c), b.events.enableBlur())
            }), h.on(b._mousedown + " " + b._mouseup, function(a) {
            ...
            }), h.on("focus", "input, textarea, button, select", function(c) {
            ...
            }), h.on("keydown", "input, textarea, button, select", function(d) {
                var f = d.which;
                if (a.FroalaEditor.KEYCODE.TAB == f) {
                    d.preventDefault();
                    var i = h.find("input, textarea, button, select").filter(":visible").not(":disabled").toArray();
                    i.sort(function(b, c) {
                ...
                if (a.FroalaEditor.KEYCODE.ENTER == f) h.find(".fr-submit:visible").length > 0 && (d.preventDefault(), d.stopPropagation(), b.events.disableBlur(), b.button.exec(h.find(".fr-submit:visible:first")));
                else {
                    if (a.FroalaEditor.KEYCODE.ESC == f) return d.preventDefault(), d.stopPropagation(), b.$el.find(".fr-marker") && (b.events.disableBlur(), a(this).data("skip", !0), b.events.focus(), b.selection.restore(), b.events.enableBlur()), e(c) && h.find(".fr-back:visible").length ? b.button.exec(h.find(".fr-back:visible:first")) : g(c), b.opts.toolbarInline && b.toolbar.showInline(null, !0), !1;
                    d.stopPropagation()
                }
            }), b.events.on("window.keydown", function(d) {
                var f = d.which;
                if (a.FroalaEditor.KEYCODE.ESC == f) {
                    if (e(c) && b.opts.toolbarInline) return d.stopPropagation(), e(c) && h.find(".fr-back:visible").length ? b.button.exec(h.find(".fr-back:visible:first")) : (g(c), b.toolbar.showInline(null, !0)), !1;
                    e(c) && h.find(".fr-back:visible").length ? b.button.exec(h.find(".fr-back:visible:first")) : g(c)
                }
            }), b.$wp && (b.events.on("keydown", function(d) {
                b.keys.ctrlKey(d) || d.which == a.FroalaEditor.KEYCODE.ESC || (e(c) && h.find(".fr-back:visible").length ? b.button.exec(h.find(".fr-back:visible:first")) : g(c))
            }), h.on("blur", "input, textarea, button, select", function(c) {
                document.activeElement != this && a(this).is(":visible") && (b.events.blurActive() && b.events.trigger("blur"), b.events.enableBlur())
            })), h.on("mousedown touchstart touch", "*", function(a) {
                ...
                h.is(":visible") && t && h.find("input:focus, textarea:focus, button:focus, select:focus").filter(":visible").length > 0 && b.events.disableBlur()
            }, !0), b.events.on("window.mouseup", function(a) {
                h.is(":visible") && t && (a.stopPropagation(), b.markers.remove(), g(c))
            }, !0), b.events.on("blur", function(a) {
                l()
            }), h.on("keydown keyup change input", "input, textarea", function(b) {
                var c = a(this).next();
                0 == c.length && a(this).after("<span>" + a(this).attr("placeholder") + "</span>"), a(this).toggleClass("fr-not-empty", "" != a(this).val())
            }), b.$wp && !b.helpers.isMobile() && b.$wp.on("scroll.popup" + c, function(a) {
                if (e(c) && h.parent().get(0) == b.$box.get(0)) {
                    var d = h.position().top - b.$wp.position().top,
                        f = (b.$wp.scrollTop(), b.$wp.outerHeight());
                    d > f || 0 > d ? h.addClass("fr-hidden") : h.removeClass("fr-hidden")
                }
            }), h
        }
        ...
        function r() {
            b.events.on("destroy", q, !0), b.events.on("window.mousedown", m), b.events.on("window.touchmove", n), b.events.on("window.mouseup", function() {
                t = !1
            })
        }
        var s = {},
...
function(a) {
    ...
    a.FroalaEditor.MODULES.position = function(b) {
        ...
        function h(c) {
            ...
            if ("undefined" == typeof g && (d.data("sticky-top", 0), d.after('<div class="fr-sticky-dummy" style="height: ' + d.outerHeight() + 'px;"></div>'), d.data("sticky-dummy", d.next())), b.selection.inEditor() || b.$tb.find("input:visible:focus").length > 0) {
        ...
        function i(c) {
            if (c.offsetWidth) {
                var d, e, f = a(c),
                    ...
                    j = a(b.original_window).scrollTop(),
                    k = a(b.original_window).height(),
                    l = f.is(".fr-sticky-on"),
                    m = f.parent(),
                    n = m.offset().top,
                    o = m.outerHeight();
        ...
        function k() {
            if (!j())
                if (b._stickyElements = [], b.helpers.isIOS()) {
                    ...
                    c(), a(b.original_window).on("touchmove.sticky" + b.id, function() {
                        if (b.selection.inEditor && b.$el.is(":focus"))
                    ...
                    a(b.original_window).on("scroll.sticky" + b.id, d), a(b.original_window).on("resize.sticky" + b.id, d), b.events.on("initialized", d), b.events.on("focus", d)
                }
        }
        ...
        function m() {
            a(b.original_window).off("touchmove.sticky" + b.id), a(b.original_window).off("scroll.sticky" + b.id), a(b.original_window).off("resize.sticky" + b.id)
        }

        function n() {
            k(), b.events.on("destroy", m, !0)
        }
        return {
            require: ["events"],
            _init: n,
    ...
    a.extend(a.FroalaEditor.DEFAULTS, {
        ...
        function e(c, d) {
            b.helpers.isMobile() ? b.toolbar.show() : setTimeout(function() {
                ...
                else if (b.selection.inEditor() && b.$el.is(":focus") && !b.popups.areVisible() && (b.opts.toolbarVisibleWithoutSelection || "" !== b.selection.text() || d)) {
        ...
        function l() {
            return b.$wp ? (b.$tb = a('<div class="fr-toolbar"></div>'), b.opts.theme && b.$tb.addClass(b.opts.theme + "-theme"), "auto" != b.opts.direction && b.$tb.removeClass("fr-ltr fr-rtl").addClass("fr-" + b.opts.direction), b.helpers.isMobile() ? b.$tb.addClass("fr-mobile") : b.$tb.addClass("fr-desktop"), j(), o = b.$tb.get(0).ownerDocument, p = "defaultView" in o ? o.defaultView : o.parentWindow, c(), d(), b.$tb.on(b._mousedown + " " + b._mouseup, function(a) {
                var b = a.originalEvent ? a.originalEvent.target || a.originalEvent.originalTarget : null;
